...
interface ModalState {
  ...
  isPromoDetailsModalOpen: boolean;
  openPromoDetailsModal: () => void;
  closePromoDetailsModal: () => void;
}
...
export const useModalStore = create<ModalState>((set) => ({
  ...
  openPromoDetailsModal: () => set({ isPromoDetailsModalOpen: true }),
  closePromoDetailsModal: () => set({ isPromoDetailsModalOpen: false }),
}));
