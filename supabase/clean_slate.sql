...
ALTER TABLE public.profiles DISABLE TRIGGER profiles_id_fkey;

INSERT INTO public.profiles (id, name, role)
VALUES ('00000000-0000-0000-0000-000000000000', 'Upendo', 'system')
ON CONFLICT (id) DO NOTHING;

ALTER TABLE public.profiles ENABLE TRIGGER profiles_id_fkey;
