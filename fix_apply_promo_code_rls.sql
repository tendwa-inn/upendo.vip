-- Fix apply_promo_code function to handle RLS properly
-- This function needs to run with SECURITY DEFINER to bypass RLS policies
-- when inserting into user_promos table
